...
// ── Montserrat — downloadable via GMS, used for expressive/display titles ─────
...
// ── Expressive display typography using Montserrat ───────────────────────────
...
// ── Google Sans Flex — bundled variable font, ROND = 100 (Google Sans Rounded) ─
...
// ── Full M3 Typography scale — all UI text uses Google Sans Rounded ───────────
val YearDotsTypography = Typography(
    displayLarge = TextStyle(
